...
const char* ssid = "Padmaja";
const char* password = "padmajakeella";
      ...
      if (client.available()) { 
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<style>html { font-family: Algerian; display: inline-block; margin: 0px auto; text-align: center;background-color:#d5ee01}");
            client.println(".button { background-color: #1f1a6d; border: 1px; color: white; padding: 16px 40px;");
            client.println("text-decoration: none; font-size: 40px; margin: 2px; cursor: pointer;}");
            client.println(".button2 {background-color: #1f1a6d;border:1px;color: black}</style></head>");
            // Web Page Heading
            client.println("<body><h1 background-color:blue>HOME CONTROL DEVICES</h1>");
            client.println("<body><h2>THE DEVICES ARE:</h2>");
            ...
            client.println("<p>COOLER " + relay2State + "</p>");
            ...
            client.println("<p>LIGHT " + relay3State + "</p>");
            // If the output26State is off, it displays the ON button       
            if (relay3State=="off") {
            ...
            // Display current state, and ON/OFF buttons for GPIO 27  
            client.println("<p>AC " + relay4State + "</p>");
            // If the output27State is off, it displays the ON button       
            if (relay4State=="off") {
            ...
            // Display current state, and ON/OFF buttons for GPIO 27  
            client.println("<p>WASHING MACHINE " + relay6State + "</p>");
            // If the output27State is off, it displays the ON button       
            if (relay6State=="off") {
            ...
            client.println("<p>INVERTOR " + relay7State + "</p>");
            // If the output26State is off, it displays the ON button       
            if (relay7State=="off") {
            ...
            // Display current state, and ON/OFF buttons for GPIO 27  
            client.println("<p>TELEVISION " + relay4State + "</p>");
            // If the output27State is off, it displays the ON button       
            if (relay8State=="off") {
